...
namespace ITI_Raqmiya_MVC.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ProductCategoriesController(RaqmiyaContext context)
        {
            _context = context;
        }
        ...
        {
            var raqmiyaContext = _context.ProductCategories.Include(p => p.Category).Include(p => p.Product);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,CategoryId")] ProductCategory productCategory)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "Currency", productCategory.ProductId);
            return View(productCategory);
        }
